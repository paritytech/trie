...
mod test {
	...
	fn previous_doc_test_1() {
		...
		assert_eq!(sec_trie_root::<KeccakHasher, NoMeta, ReferenceTrieStream, _, _, _>(v, Default::default()), root);
	}
	...
	fn previous_doc_test_2() {
		...
		assert_eq!(trie_root::<KeccakHasher, NoMeta, ReferenceTrieStream, _, _, _>(v, Default::default()), root);
	}
}
