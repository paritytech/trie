...
use super::{Result, DBValue, TrieMut, TrieDBMut, TrieLayout, TrieHash, CError, Value, GlobalMeta};
	...
	L: TrieLayout,
{
	...
	pub fn db(&self) -> &dyn HashDB<L::Hash, DBValue, L::Meta, GlobalMeta<L>> { self.raw.db() }

	/// Get the backing database.
	pub fn db_mut(&mut self) -> &mut dyn HashDB<L::Hash, DBValue, L::Meta, GlobalMeta<L>> { self.raw.db_mut() }
}
