...
mod rstd {
    ...
    pub use std::{
        borrow, boxed, cmp, convert, fmt, hash, iter, marker, mem, ops, rc, result, sync, vec,
    };
}
...
mod rstd {
    ...
    pub use alloc::{boxed, rc, sync, vec};
...
pub use self::nibble::{nibble_ops, NibbleSlice, NibbleVec};
pub use self::recorder::Recorder;
pub use self::sectriedb::SecTrieDB;
pub use self::sectriedbmut::SecTrieDBMut;
pub use self::triedb::{TrieDB, TrieDBBuilder, TrieDBIterator};
pub use self::triedbmut::{ChildReference, TrieDBMut, TrieDBMutBuilder};
pub use crate::iter_build::{
    trie_visit, ProcessEncodedNode, TrieBuilder, TrieRoot, TrieRootUnhashed,
};
    ...
    L: TrieLayout + 'db,
{
    ...
    pub fn from_existing(
        ...
        match self.spec {
            TrieSpec::Generic => Ok(Box::new(
                TrieDBMutBuilder::<L>::from_existing(db, root)?.build(),
            )),
