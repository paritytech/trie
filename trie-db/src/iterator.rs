...
use crate::node::{NodeHandle, NodePlan, OwnedNode};
...
mod tests {
    ...
    use reference_trie::{
        node::Node, NibbleSlice, NibbleVec, RefTrieDB, RefTrieDBMut, TrieDBNodeIterator, TrieError,
        TrieIterator, TrieMut,
    };
    use reference_trie::{RefTrieDBMutNoExt, RefTrieDBNoExt};

    type MemoryDB =
        memory_db::MemoryDB<KeccakHasher, memory_db::PrefixedKey<KeccakHasher>, DBValue>;
