    ...
    V: AsRef<[u8]>,
{
    ...
    fn no_extension(
        ...
        let pr = NibbleSlice::new_offset(&key_branch.as_ref()[..], branch_d - ext_length);
...
mod test {
    ...
    fn polka_re_test() {
        compare_implementations(vec![
            (
                vec![77, 111, 111, 55, 111, 104, 121, 97],
                vec![68, 97, 105, 55, 105, 101, 116, 111],
            ),
            (
                vec![101, 105, 67, 104, 111, 111, 66, 56],
                vec![97, 56, 97, 113, 117, 53, 97],
            ),
            (
                vec![105, 97, 48, 77, 101, 105, 121, 101],
                vec![69, 109, 111, 111, 82, 49, 97, 105],
            ),
        ]);
    }
}
