...
#[derive(Eq, PartialEq, Clone)]
#[cfg_attr(feature = "std", derive(Debug))]
pub enum Node<'a, L> { // TODO HERE node need attached content location so when change in triedbmut this content is kept
					   // see how it is stored in triedbmut `Node`
