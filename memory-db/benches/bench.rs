...
criterion_group!(benches, instantiation, compare_to_null_embedded_in_struct,
	compare_to_null_in_const, contains_with_non_null_key, contains_with_null_key);
...
fn compare_to_null_embedded_in_struct(b: &mut Criterion) {
	...
	b.bench_function("compare_to_null_embedded_in_struct", |b| b.iter(|| {
...
fn compare_to_null_in_const(b: &mut Criterion) {
	...
	b.bench_function("compare_to_null_in_const", |b| b.iter(|| {
